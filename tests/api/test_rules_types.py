...
class TestCalculationRuleType:
    ...
    def test_create_calculation_rule_with_set_value(
        self, client: TestClient, admin_headers, db_session, draft_version
    ):
    ...
    def test_calculation_requires_set_value(
        self, client: TestClient, admin_headers, db_session, draft_version
    ):
    ...
    def test_calculation_rejects_target_value_id(
        self, client: TestClient, admin_headers, db_session, draft_version
    ):
    ...
    def test_calculation_rejects_error_message(
        self, client: TestClient, admin_headers, db_session, draft_version
    ):
    ...
    def test_set_value_accepted_for_free_field(
        self, client: TestClient, admin_headers, db_session, draft_version
    ):
    ...
    def test_set_value_valid_for_non_free_field(
        self, client: TestClient, admin_headers, db_session, draft_version
    ):
