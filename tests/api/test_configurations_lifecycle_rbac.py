...
class TestUserRolePermissions:
    ...
    def test_user_read_only_own_finalized(
    ...
    def test_user_can_clone_own_finalized(
        self, client, lifecycle_user_headers, finalized_configuration
    ):
    ...
    def test_user_cannot_delete_finalized(
        self, client, lifecycle_user_headers, finalized_configuration
    ):
    ...
    def test_user_cannot_upgrade_finalized(
        self, client, lifecycle_user_headers, finalized_configuration
    ):
    ...
    def test_user_no_access_others_configs(
        ...
        # Clone
        clone_response = client.post(
            f"/configurations/{second_user_draft_configuration.id}/clone",
            headers=lifecycle_user_headers
        )
        ...
        # Finalize
        finalize_response = client.post(
            f"/configurations/{second_user_draft_configuration.id}/finalize",
            headers=lifecycle_user_headers
        )
    ...
    def test_user_can_delete_own_draft(
...
class TestAuthorRolePermissions:
    ...
    def test_author_same_restrictions_as_user(
    ...
    def test_author_full_access_own_draft(
        self, client, lifecycle_author_headers, author_owned_draft_configuration
    ):
        ...
        # Clone
        clone_response = client.post(
            f"/configurations/{author_owned_draft_configuration.id}/clone",
            headers=lifecycle_author_headers
        )
        assert clone_response.status_code == 201
    ...
    def test_author_can_finalize_own(
        self, client, lifecycle_author_headers, author_owned_draft_configuration
    ):
        """AUTHOR can finalize own DRAFT configuration."""
        response = client.post(
            f"/configurations/{author_owned_draft_configuration.id}/finalize",
            headers=lifecycle_author_headers
        )
...
class TestAdminRolePermissions:
    ...
    def test_admin_can_access_all_configs(
        self, client, lifecycle_admin_headers,
        draft_configuration, second_user_draft_configuration
    ):
    ...
    def test_admin_can_clone_any_config(
        self, client, lifecycle_admin_headers,
        draft_configuration, finalized_configuration
    ):
    ...
    def test_admin_can_view_deleted_configs(
    ...
    def test_admin_can_finalize_any_config(
    ...
    def test_admin_can_upgrade_any_config(
...
class TestCrossRoleInteractions:
    ...
    def test_user_creates_admin_finalizes(
        ...
        lifecycle_user_headers, lifecycle_admin_headers,
        published_version_for_lifecycle
    ):
    ...
    def test_author_creates_user_cannot_access(
        self, client, lifecycle_author_headers, lifecycle_user_headers,
        published_version_for_lifecycle
    ):
    ...
    def test_admin_soft_deletes_user_cannot_see(
        self, client, db_session,
        lifecycle_admin_headers, lifecycle_user_headers,
        admin_owned_finalized_configuration, lifecycle_user
    ):
    ...
    def test_user_creates_user2_cannot_modify(
        self, client, lifecycle_user_headers, second_lifecycle_user_headers,
        draft_configuration
    ):
