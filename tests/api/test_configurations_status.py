...
class TestListConfigurationsStatus:
    ...
    def test_list_excludes_deleted_by_default(
        self, client, lifecycle_user_headers, draft_configuration, soft_deleted_configuration,
        db_session, lifecycle_user
    ):
    ...
    def test_list_include_deleted_admin_only(
    ...
    def test_list_include_deleted_denied_for_user(
        self, client, lifecycle_user_headers, soft_deleted_configuration,
        db_session, lifecycle_user
    ):
    ...
    def test_list_filter_invalid_status(
    ...
    def test_list_combines_status_and_deleted_filters(
        ...
        finalized_configuration, soft_deleted_configuration
    ):
...
class TestReadConfigurationStatus:
    ...
    def test_read_returns_status_field(
    ...
    def test_read_returns_is_deleted_field(
        self, client, lifecycle_user_headers, draft_configuration
    ):
    ...
    def test_read_deleted_config_404_for_user(
        ...
        response = client.get(
            f"/configurations/{soft_deleted_configuration.id}",
            headers=lifecycle_user_headers
        )
    ...
    def test_read_deleted_config_visible_to_admin(
        self, client, lifecycle_admin_headers, soft_deleted_configuration
    ):
...
class TestUpdateConfigurationStatus:
    ...
    def test_update_finalized_blocked(
    ...
    def test_update_finalized_error_message(
        self, client, lifecycle_user_headers, finalized_configuration
    ):
    ...
    def test_update_draft_name_only(
        self, client, lifecycle_user_headers, draft_configuration
    ):
    ...
    def test_update_cannot_change_status_via_patch(
        self, client, lifecycle_user_headers, draft_configuration
    ):
    ...
    def test_update_deleted_config_still_accessible(
        self, client, lifecycle_admin_headers, soft_deleted_configuration
    ):
...
class TestDeleteConfigurationStatus:
    ...
    def test_delete_draft_hard_delete_owner(
    ...
    def test_delete_finalized_denied_for_user(
        self, client, lifecycle_user_headers, finalized_configuration
    ):
    ...
    def test_delete_finalized_error_message(
        self, client, lifecycle_user_headers, finalized_configuration
    ):
        """Error message should suggest using clone."""
        response = client.delete(
