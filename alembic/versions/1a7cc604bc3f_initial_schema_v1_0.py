...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "updated_at", sa.DateTime(timezone=True), nullable=True, comment="Timestamp when record was last updated"
        ),
        sa.Column("created_by_id", sa.String(length=36), nullable=True, comment="ID of user who created this record"),
        sa.Column(
            "updated_by_id", sa.String(length=36), nullable=True, comment="ID of user who last updated this record"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "sku_delimiter", sa.String(length=5), nullable=False, comment="Delimiter for SKU segments (default: '-')"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "generated_sku", sa.String(length=100), nullable=True, comment="Cached generated SKU from last calculation"
        ),
        sa.Column(
            "is_deleted",
            sa.Boolean(),
    ...
    op.create_table(
        ...
        sa.Column(
            "default_value", sa.String(length=255), nullable=True, comment="Default value for free-value fields only"
        ),
        sa.Column(
            "sku_modifier_when_filled",
            sa.String(length=20),
            nullable=True,
            comment=(
